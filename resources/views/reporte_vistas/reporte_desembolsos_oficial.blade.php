...
<head>
    <meta charset="UTF-8">
    <title>Reporte de Desembolsos x Oficial credito</title>
    <style>
        body { 
...
<body>
    <div class="container">
            ...
            <tr>
                <td style="padding: 0; text-align: center; vertical-align: middle;">
                    <div style="width: 100%; height: 100%; justify-content: center; align-items: center;">
                        <h1 style="font-size: 20px; margin: 0; padding: 10px 0; text-align: center; color: rgb(0, 0, 0);">REPORTE DE DESEMBOLSOS x OFICIAL CREDITO</h1>
                    </div>
                </td>
            </tr>
        </table>
        ...
        <p style="font-size:14px;"><strong>Asesor: </strong> {{ $nombre_asesor }} - CI: {{$ci_asesor}} </p>
        ...
        {{-- aqui la informacion del asesor --}}

        {{-- seccion informacion a modificar --}}
        <div class="">
        ...
        {{-- fin seccion informacion a modificar --}}
