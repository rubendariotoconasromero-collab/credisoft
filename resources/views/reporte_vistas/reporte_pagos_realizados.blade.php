...
<body>
    <div class="container">
            ...
            <tr>
                <td style="padding: 0; text-align: center; vertical-align: middle;">
                    <div style="width: 100%; height: 100%; justify-content: center; align-items: center;">
                        <h1 style="font-size: 20px; margin: 0; padding: 10px 0; text-align: center; color: rgb(0, 0, 0);">REPORTE DE PAGOS REALIZADOS</h1>
                    </div>
                </td>
            </tr>
        </table>
        ...
        <p><strong>Total de pagos:</strong> {{ number_format($total_pagos, 2) }} Bs</p>

        <div class="">
            <table style="width:100%;" class="data-table">
                <thead>
                    <tr>
                        <th style="padding: 3px; font-size: 10px;">ID Pago</th>
                        <th style="padding: 3px; font-size: 10px;">Fecha</th>
                        <th style="padding: 3px; font-size: 10px;">Forma</th>
                        <th style="padding: 3px; font-size: 10px;">Asesor</th>
                        <th style="padding: 3px; font-size: 10px;">Cliente</th>
                        <th style="padding: 3px; font-size: 10px;">Cuota</th>
                        <th style="padding: 3px; font-size: 10px;">Total</th>
                        <th style="padding: 3px; font-size: 10px;">S. Capital</th>
                        <th style="padding: 3px; font-size: 10px;">Capital</th>
                        <th style="padding: 3px; font-size: 10px;">Interés</th>
                        <th style="padding: 3px; font-size: 10px;">Monto</th>
                        <th style="padding: 3px; font-size: 10px;">Estado</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($detalles as $pago)
                        <tr>
                            ...
                            <td>{{ $pago->cliente }}</td>
                            <td>{{ $pago->cuota }} / {{ $pago->nro_cuotas }}</td>
                            <td>{{ number_format($pago->total_pago_credito, 2) }}</td>
