...
<body>
    <div class="container">
            ...
            <tr>
                <td style="padding: 0; text-align: center; vertical-align: middle;">
                    <div style="width: 100%; height: 100%; justify-content: center; align-items: center;">
                        <h1 style="font-size: 20px; margin: 0; padding: 10px 0; text-align: center; color: rgb(0, 0, 0);">REPORTE DE PAGOS PROGRAMADOS</h1>
                    </div>
                </td>
            </tr>
        </table>
        ...
        <p><strong>Total de pagos:</strong> {{ number_format($total_pagos_programados, 2) }} Bs</p>
            ...
            <table style="width:100%;" class="data-table">
                <thead>
                    <tr>
                        ...
                        <th style="padding: 3px; font-size: 10px;">Total Credito</th>
                ...
                <tbody>
                    @foreach($detalles as $pago)
                        <tr>
                            ...
                            <td>
                                @if ($pago->dias_pasados > 0)
                                    <span style="color: red;">MORA - ({{ $pago->dias_pasados }} días)</span>
                                @else
                                    <span style="color: green;">SIN MORA</span>
                                @endif
                            </td>
