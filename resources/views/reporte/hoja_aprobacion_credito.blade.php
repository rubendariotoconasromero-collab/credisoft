...
<head>
    <meta charset="UTF-8">
    <title>SHoja de Aprobación del Prestamo</title>
    <style>
        body {
        ...
        <table class="header-table">
            <tr>
                ...
                <td class="company-cell">
                    <p class="report-title">Hoja de Aprobación del Prestamo</p>
                </td>
                                                ...
                                                @elseif($telefono->tipo == 'Informacion contacto')
                                                    ...
                                                    <div style="margin-left: 12px;">
                                                        ...
                                                        @if(!empty($telefono->nombre) || !empty($telefono->apellidos))
                                                            <span style="color: #666; font-size: 10px;"> - {{ trim($telefono->nombre . ' ' . $telefono->apellidos) }}</span>
                                                        @endif
                                                    </div>
