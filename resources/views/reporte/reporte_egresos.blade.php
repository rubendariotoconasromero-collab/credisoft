...
@section('report_title', 'Reporte de Egresos')
...
@section('totals_box')
    <div style="border: 1px solid #a3a3a3; border-radius: 6px; padding: 10px; background-color: #f9fafb; margin-top: 15px; margin-bottom: 15px;">
        <table class="data-table" style="margin-bottom: 0; width: 100%; border: none;">
            <tr>
                <th style="width: 50%; text-align: center;">Total Egresos Realizados</th>
        ...
        <table class="data-table" style="margin-bottom: 0; border: none;">
            <thead>
                <tr style="background-color: #f3f4f6;">
                    ...
                    <th style="text-align:left; border-bottom: 1px solid #a3a3a3;">Tipo de Egreso</th>
                    <th style="text-align:left; border-bottom: 1px solid #a3a3a3;">Descripción / Detalle</th>
                    <th style="text-align:right; border-bottom: 1px solid #a3a3a3;">Monto Realizado (Bs)</th>
                </tr>
            </thead>
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="5" style="text-align:center; padding: 15px; color: #718096; font-style: italic;">No existen egresos en este periodo.</td>
                </tr>
                @endforelse
                <tr style="font-weight: bold; background-color: #f3f4f6;">
                    <td colspan="4" style="text-align:right; border-top: 1px solid #a3a3a3;">TOTAL EGRESOS:</td>
