...
<head>
    ...
    <style>
        ...
        .header-table { width: 100%; border-bottom: 2px solid #dc3545; padding-bottom: 10px; margin-bottom: 20px; }
        ...
        .report-title { font-size: 16px; font-weight: bold; color: #dc3545; margin: 0; text-transform: uppercase;}
        .filtros-box { background-color: #f8f9fa; border: 1px solid #dee2e6; padding: 10px; margin-bottom: 15px; font-size: 10px; }
        .ledger-table { width: 100%; border-collapse: collapse; }
        .ledger-table thead th { background-color: #dc3545; color: #ffffff; padding: 8px 5px; font-size: 9px; text-transform: uppercase; text-align: center; border: 1px solid #dc3545; }
        ...
        .col-monto { font-weight: bold; color: #dc3545; }
        .tfoot-row td { background-color: #e9ecef; color: #000; font-weight: bold; padding: 8px 5px; border-top: 2px solid #dc3545; }
    </style>
</head>
<body>
    <?php
    ...
    <table class="header-table">
        <tr>
            ...
            <td width="34%" class="text-center"><h1 class="report-title">REPORTE DE EGRESOS</h1></td>
    ...
    <table class="ledger-table">
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="5" class="text-center" style="padding:20px;">No existen egresos en este periodo.</td></tr>
            @endforelse
        </tbody>
        <tfoot>
            <tr class="tfoot-row">
