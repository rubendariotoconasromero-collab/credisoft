...
<head>
    <meta charset="UTF-8">
    <title>Informe de Codeudor</title>
    <style>
...
<body>
    ...
    <div class="client-image-container">
        @if ($codeudor->imagen)
            <img class="client-image" src="{{ public_path('img/codeudor/' . $codeudor->imagen) }}" alt="Foto del codeudor">
        @else
            <img class="client-image" src="{{ public_path('img/codeudor/default.png') }}" alt="Foto por defecto">
        @endif
    </div>
    ...
    <table class="data-table">
        ...
        <tr>
            ...
            <td>{{ $codeudor->fecha_nacimiento }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>{{ $codeudor->estado_civil }}</td>
        </tr>
        <tr>
            <th style="width:50%">Tipo de Vivienda</th>
            <td>{{ $codeudor->vivienda }}</td>
        </tr>
        <tr>
            <th style="width:50%">Ingreso Mensual</th>
            <td><span class="text-primary text-bold">{{  number_format($codeudor->ingreso_mensual ?? 0, 2)  }} Bs.</span></td>
        </tr>
        <tr>
