            ...
            <tr>
                <td style="padding: 0; text-align: center; vertical-align: middle;">
                    <div style="width: 100%; height: 100%; justify-content: center; align-items: center;">
                        <h1 style="font-size: 20px; margin: 0; padding: 10px 0; text-align: center; color: rgb(0, 0, 0);">LISTADO GENERAL DE PLANES PAGO</h1>
                    </div>
                </td>
            </tr>
        </table>
            ...
            <table class="data-table">
                <thead>
                    <tr>
                        ...
                        <th style="">Monto total</th>
                        <th style="">Nro cuotas</th>
                        <th style="">Estado</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ retornarEstado($plan_pago->estado_plan) }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
