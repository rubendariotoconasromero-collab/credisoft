                ...
                <td>
                    <div style="border: 1px solid #000; border-radius: 10px; padding: 10px;">
                        <table class="data-table" >
                            ...
                            <tr>
                                <th>Gastos Adm.</th>
                                <td>{{ $informacion[0]->importe_solicitud *0.01 }}</td>
                            </tr>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center">{{ number_format($detalle['capital'], 0, '', '.') }}</td>
                                <td style="text-align:center">{{ number_format($detalle['interes'], 0, '', '.') }}</td>
                                <td style="text-align:center">{{ number_format($detalle['saldo_capital'], 0, '', '.') }}</td>
                                <td style="text-align:center">{{ number_format($detalle['total'], 0, '', '.') }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
