...
<body>
    ...
    <div>
        ...
        <div class="seccion">
            <h4 class="card-title text-uppercase mt-3" style="text-align: center">Listado de solicitudes</h4>
            <p style="text-align:center">Desde <strong>{{$fecha_inicial}}</strong> hasta <strong>{{$fecha_final}}</strong></p>
