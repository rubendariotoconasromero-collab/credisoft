                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12 my-3">
                                                <button class="btn btn-outline-warning w-100" @click="generarReportePagosRealizados()">
...
<script>
    ...
    export default {
        ...
        methods: {
            generarReportePagosRealizados(){
            
                // Construye la URL con el parámetro fecha_inicio
                const url = '/generar_reporte_pagos_realizados?fecha_final='+this.fecha_fin
