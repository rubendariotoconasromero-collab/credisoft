                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <div class="page-title">
                                <h4 class="mb-0 font-size-18 text-uppercase">
                                    ...
                                    Reporte Desembolsos x Oficial Credito</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12 my-3">
                                                <button class="btn btn-outline-warning w-100" @click="generarReporteDesembolsos()">
    ...
    export default {
        ...
        methods: {
            ...
            generarReporteDesembolsos(){
                ...
                const url = '/reporte_desembolsos_oficial?fecha_final='+this.fecha_fin
