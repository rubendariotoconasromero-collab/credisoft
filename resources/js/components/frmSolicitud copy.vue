<template>
    <main>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    <input @input="buscarSolicitud()" v-model="fecha_inicial_buscar"
                                                        type="date" name="" id="" class="form-control">
                                                    ...
                                                    <input @input="buscarSolicitud()" v-model="fecha_final_buscar"
                                                        type="date" name="" id="" class="form-control">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group">
                                                    <select v-model="criterio_estado" class="form-select form-control"
                                                        @change="buscarSolicitud()">
                                                    ...
                                                    <input :placeholder="'Ingrese texto a buscar'" v-model="buscar"
                                                        type="text" class="form-control" @input="buscarSolicitud()">
                                            ...
                                            <div class="col-md-3 text-end">
                                                <button @click="abrirCalculadoraCredito()"
                                            ...
                                            <table class="table mb-4 table-sm table-striped table-hover">
                                                ...
                                                <tbody>
                                                    <tr class="align-middle"
                                                        v-for="item in lista_solicitudes.filter(solicitud => solicitud.estado !==10)"
                                                        :key="item.id">

                                                        <td>{{ item.id }}</td>
                                                        <td>{{ item.cliente }}</td>
                                                        <td>
                                                            <p class="my-0 my-0 text-dark"
                                                                v-for="(item, index) in lista_codeudores_tabla.filter(codeudor => codeudor.id_solicitud === item.id)"
                                                                :key="index">
                                                                * {{item.nombre}}
                                                            </p>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span v-else-if="item.estado==0"
                                                                class="text-danger">Anulado</span>
                                                            <span v-else-if="item.estado==2"
                                                                class="text-success">Aprobado</span>
                                                        </td>
                                                        <td>
                                                            <div class="btn-group">
                                                                <a style="cursor:pointer;"
                                                                    class="text-success dropdown-toggle btn-sm my-0 py-0"
                                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                                                    <i class="fas fa-ellipsis-h fa-lg fa-fw fs-4"></i>

                                                                </a>
                                                                <ul class="dropdown-menu my-0 py-0">
                                                                    <li @click="desactivarSolicitud(item)"
                                                                        v-if="item.estado==1">
                                                                        <a class="dropdown-item text-danger" href="#">
                                                                            <i class="fas fa-times"></i> Anular</a>
                                                                    </li>
                                                                    <li @click="activarSolicitud(item)"
                                                                        v-else-if="item.estado==0"><a
                                                                            class="dropdown-item text-success" href="#">
                                                                            <i class="fas fa-check"></i> activar</a>
                                                                    </li>
                                                                    <li v-if="item.estado==1"
                                                                        @click="editarSolicitud(item)"><a
                                                                    ...
                                                                    <li v-if="item.estado!=0 && item.estado!=2 && rolUsuario=='administrador'"
                                                                        @click="abrirModalSimulacionPlanPago(item)"><a
                                                                            class="dropdown-item text-success" href="#">
                                                                            <i class="fas fa-money-bill"></i> Aprobar
                                                                            solicitud</a></li>

                                                                    <li v-if="item.tipo_garantia=='Prendario'"
                                                                        @click="abrirModalGarantias(item.id)"><a
                                                                            class="dropdown-item text-secondary"
                                                                            href="#">
                                                                            <i class="fas fa-images"></i> Garantias</a>
                                                                    </li>
                                                                    <li @click="abrirModalRespaldos(item.id)"><a
                                                                            class="dropdown-item text-warning" href="#">
                                                                            <i class="fas fa-images"></i> Respaldos</a>
                                                                    </li>
        ...
        <!-- Modal solicitud -->
        <div class="modal fade" id="modalSolicitud" tabindex="-1" aria-labelledby="miModalLabel" aria-hidden="true"
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable" style="max-width: 95%;">
                <div class="modal-content border border-2 border-success">
                    ...
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title text-white" id="miModalLabel">
                            <template v-if="solicitud.accion === 0">Agregar nueva solicitud</template>
                            <template v-else-if="solicitud.accion === 1">Modificar solicitud</template>
                            <template v-else>Información de la solicitud</template>
                        </h5>
                        <button type="button" class="btn-close btn-close-white" @click="cerrarModalNuevo()"
                        ...
                        <form @submit.prevent>
                            ...
                            <div class="card mb-4 border-success">
                                <div class="card-header bg-success text-white">
                                    <h5 class="mb-0 text-white"><i class="fas fa-user me-2"></i>Seleccione cliente</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-5">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="buscarCliente"
                                                        class="form-label fw-semibold text-dark">Cliente</label>
                                                    <div class="input-group">
                                                        <input type="text" v-model="cliente.idd_cliente"
                                                            id="buscarCliente" class="form-control text-dark"
                                                            placeholder="Buscar cliente..."
                                                            @input="filteredItemsClienteMetodo(cliente.idd_cliente)"
                                                            :disabled="solicitud.accion === 2" autocomplete="off"
                                                            required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12" style="position:relative;">
                                                <template v-if="filteredItemsCliente.length > 0">
                                                    <div class="com-completion-results shadow"
                                                        ...
                                                        v-bind:style="{ display: filteredItemsCliente.length > 0 && cliente.idd_cliente != '' ? 'block' : 'none' }">
                                                        <ul style="list-style: none; padding: 0; margin: 0;">
                                                            <li v-for="(clienteItem, index) in filteredItemsCliente"
                                                                :key="index" @click="seleccionarCliente(clienteItem)"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input v-model="cliente.ci" type="text" class="form-control" disabled>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label fw-bold">Actividad</label>
                                            <input v-model="cliente.actividad" type="text" class="form-control"
                                                disabled>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-4 border-success">
                                <div class="card-header bg-success text-white">
                                    <h5 class="mb-0 text-white"><i class="fas fa-users-cog me-2"></i>Seleccione
                                        codeudores/garantes
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div v-for="(item, index) in lista_codeudores" :key="index" class="row g-3 mb-3">
                                        <div class="col-md-5">
                                            ...
                                            <div class="input-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <template v-if="solicitud.accion !== 2">
                                                                <button @click="addCodeudor()" type="button"
                                                                    class="btn btn-success rounded-circle ms-2">
                                                                    <i class="fas fa-plus"></i>
                                                                </button>
                                                                <button v-if="lista_codeudores.length > 1"
                                                ...
                                                <div class="col-md-12" style="position:relative;">
                                                    <template
                                                        v-if="item.select_codeudor.codeudor.filteredItemsCodeudorAux.length > 0">
                                                        <div class="com-completion-results shadow"
                                                            style="z-index: 1050; position: absolute; top: 100%; width: 100%; background: #fff; border: 1px solid #ececec; max-height: 250px; overflow: auto;"
                                                            v-bind:style="{ display: item.select_codeudor.codeudor.filteredItemsCodeudorAux.length > 0 && item.select_codeudor.codeudor.idd_codeudor != '' ? 'block' : 'none' }">
                                                            <ul style="list-style: none; padding: 0; margin: 0;">
                                                                <li v-for="(codeudorItem, index2) in item.select_codeudor.codeudor.filteredItemsCodeudorAux"
                                                                    :key="index2"
                                        ...
                                        <div class="col-md-3">
                                            <label class="form-label fw-bold">CI</label>
                                            <input v-model="item.select_codeudor.codeudor.ci" type="text"
                                                class="form-control" disabled>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label fw-bold">Actividad</label>
                                            <input v-model="item.select_codeudor.codeudor.actividad" type="text"
                                                class="form-control" disabled>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-4 border-success">
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label fw-bold">Importe solicitud</label>
                                                <input v-model="solicitud.importe_solicitud"
                                                    :disabled="solicitud.accion === 2" type="text" class="form-control"
                                                    @input="event.target.value = event.target.value.replace(/[^0-9.]/g, '')"
                                                    :class="{ 'is-invalid': (solicitud.importe_solicitud === 0 || !solicitud.importe_solicitud) && solicitud.enviado === 1 }">
                                                <div class="invalid-feedback">Ingrese un importe *</div>
                                            </div>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-4">
                                                    ...
                                                    <select v-model="solicitud.moneda"
                                                        :disabled="solicitud.accion === 2" class="form-select"
                                                        :class="{ 'is-invalid': (!solicitud.moneda || solicitud.moneda === '0') && solicitud.enviado === 1 }">
                                                ...
                                                <div class="col-md-4">
                                                    <label class="form-label fw-bold">Tipo tasa</label>
                                                    <select v-model="tipo_tasa" :disabled="solicitud.accion === 2"
                                                        class="form-select"
                                                        @change="(tipo_tasa === 'fija' || tipo_tasa === 'amortizable') && seleccionarLapsoCapitalFormulario()"
                                                        :class="{ 'is-invalid': (!tipo_tasa || tipo_tasa === '0') && solicitud.enviado === 1 }">
                                                        <option value="0" disabled>Seleccione un tipo</option>
                                                        <option value="fija">Fija</option>
                                                        <option value="amortizable">Amortizable</option>
                                                    </select>
                                                    <div class="invalid-feedback">Seleccione tipo tasa *</div>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="form-label fw-bold">Lapso capital</label>
                                                    <select v-model="solicitud.lapso_capital"
                                                        :disabled="solicitud.accion === 2" class="form-select"
                                                        @change="(tipo_tasa === 'fija' || tipo_tasa === 'amortizable') && seleccionarLapsoCapitalFormulario()"
                                                        :class="{ 'is-invalid': (!solicitud.lapso_capital || solicitud.lapso_capital === '0') && solicitud.enviado === 1 }">
                                            ...
                                            <div class="row g-3 mt-2">
                                                <div class="col-md-6">
                                                    <label class="form-label fw-bold">Nro. cuotas</label>
                                                    <input v-model="solicitud.nro_cuotas"
                                                        :disabled="solicitud.accion === 2" type="number"
                                                        class="form-control"
                                                        :class="{ 'is-invalid': !solicitud.nro_cuotas && solicitud.enviado === 1 }">
                                                    <div class="invalid-feedback">Ingrese nro cuotas *</div>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label fw-bold">Tasa %</label>
                                                    <input v-model="solicitud.tasa" :disabled="solicitud.accion === 2"
                                                        type="text" class="form-control"
                                                        @input="event.target.value = event.target.value.replace(/[^0-9]/g, '')"
                                                        :class="{ 'is-invalid': !solicitud.tasa && solicitud.enviado === 1 }">
                                                    <div class="invalid-feedback">Ingrese tasa *</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <label class="form-label fw-bold">Fecha desembolso</label>
                                                    <input v-model="solicitud.fecha_desembolso"
                                                        :disabled="solicitud.accion === 2" type="date"
                                                        class="form-control"
                                                        @input="(tipo_tasa === 'fija' || tipo_tasa === 'amortizable') && seleccionarLapsoCapitalFormulario()">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label fw-bold">Fecha primera cuota</label>
                                                    <input v-model="solicitud.fecha_primera_cuota"
                                                        :disabled="tipo_tasa === 'fija' || tipo_tasa === 'amortizable'"
                                                        type="date" class="form-control">
                                                </div>
                                            </div>

                                            <div class="mt-3">
                                                <label class="form-label fw-bold">Destino préstamo</label>
                                                <input v-model="solicitud.destino_prestamo"
                                                    :disabled="solicitud.accion === 2" type="text" class="form-control"
                                                    :class="{ 'is-invalid': !solicitud.destino_prestamo && solicitud.enviado === 1 }">
                                                <div class="invalid-feedback">Ingrese un destino préstamo *</div>
                                            </div>

                                            <div class="row g-3 mt-2">
                                                <div class="col-md-6">
                                                    <label class="form-label fw-bold">Tipo desembolso</label>
                                                    <select v-model="solicitud.tipo_desembolso"
                                                        :disabled="solicitud.accion === 2" class="form-select"
                                                        :class="{ 'is-invalid': (!solicitud.tipo_desembolso || solicitud.tipo_desembolso === '0') && solicitud.enviado === 1 }">
                                                        <option value="0" disabled>Seleccione</option>
                                                        <option v-for="item in tipos_desembolsos" :value="item.nombre"
                                                            :key="item.nombre">
                                                            {{ item.nombre }}
                                                        </option>
                                                        <option value="10">Electrodoméstico</option>
                                                        <option value="11">Mueble</option>
                                                    </select>
                                                    <div class="invalid-feedback">Seleccione un tipo desembolso *</div>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label fw-bold">Tipo garantía</label>
                                                    <select v-model="solicitud.tipo_garantia"
                                                        :disabled="solicitud.accion === 2" class="form-select"
                                                        :class="{ 'is-invalid': (!solicitud.tipo_garantia || solicitud.tipo_garantia === '0') && solicitud.enviado === 1 }">
                                                        <option value="0" disabled>Seleccione</option>
                                                    ...
                                                    <div class="invalid-feedback">Seleccione un tipo garantía *</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!-- Guarantees Table -->
                            <div v-if="solicitud.tipo_garantia === 'Prendario'" class="table-responsive mb-4">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th class="fw-bold">Descripción</th>
                                            <th v-if="solicitud.accion !== 2" class="fw-bold">Opciones</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr v-for="(item, index) in lista_garantias" :key="index">
                                            <td>
                                                <input v-model="item.descripcion" :disabled="solicitud.accion === 2"
                                                    type="text" class="form-control"
                                                    :class="{ 'is-invalid': !item.descripcion && solicitud.enviado === 1 }">
                                                <div class="invalid-feedback">Ingrese una descripción *</div>
                                            </td>
                                            <td v-if="solicitud.accion !== 2">
                                                <div class="btn-group">
                                                    <button @click="agregarGarantia()"
                                                        class="btn btn-success rounded-circle">
                                                        <i class="fas fa-plus"></i>
                                                    </button>
                                                    <button v-if="lista_garantias.length > 1"
                                                        @click="quitarGarantia(index)"
                            ...
                            <div class="modal-footer justify-content-center">
                                ...
                                <button v-if="solicitud.accion === 0" type="button" class="btn btn-success"
                                    :disabled="guardando_solicitud" @click="guardarSolicitud()">
                                    <i class="fas fa-save me-2"></i>Guardar
                                </button>
                                <button v-if="solicitud.accion === 1" type="button" class="btn btn-success"
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button @click="cerrarModalGarantias(), limpiarImagenes()" type="button" class="btn-close"
                            data-bs-dismiss="modal" aria-label="Cerrar"></button>
                    </div>
                    <form @submit.prevent="guardarImagen()">
                        <div class="modal-body">
                            <div clas="row" v-for="(item, index) in lista_garantias_imagenes" :key="index">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4" v-for="(item2, index2) in item.lista_imagenes"
                                            :key="index2">

                                            <div class="card m-1">
                                                <img :id="'imagenPreview'+index+''+index2"
                                                    style="width: 100%; height: auto; object-fit: contain;"
                                                    alt="imagen_descripcion"
                                            ...
                                            <div class="card-footer">
                                                <div class="input-group">
                                                    ...
                                                    <button @click="eliminarImagen(index, index2)"
            ...
            <div class="modal-dialog modal-xl" style="max-width:90%; width:90%">
                <div class="modal-content border border-success border-2">
                    <div class="modal-header bg-success">
                        ...
                        <button @click="cerrarModalSimulacionPlanPago()" type="button" class="btn-close"
                            data-bs-dismiss="modal" aria-label="Cerrar"></button>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 text-center mb-3">
                                <a :disabled="aprobando_solicitud" v-if="solicitud.estado==1"
                                ...
                                <a @click="listaCuotasPdf(solicitud.id_solicitud)" class="btn btn-info btn-sm ms-2">
                                    ...
                                    Generar PDF</a>
                                <a @click="generalPlanPagosGeneral()" class="btn btn-primary btn-sm ms-2">Generar plan
                                    pagos</a>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <p class="col-md-8">{{ cliente_simulacion.ci+' '+
                                        cliente_simulacion.lugar_expedicion}}</p>
                                </div>
                                <div class="row">
                                    <label class="col-md-4">
                                ...
                                <div class="row input-group">
                                    ...
                                    <h5 class="col-md-12">
                                        <span style="border-radius:5px"
                                            :class="gestionarEstado(solicitud.estado)=='Nuevo'?'badge bg-success':gestionarEstado(solicitud.estado)=='Aprobado'?'badge bg-danger':gestionarEstado(solicitud.estado)=='Anulado'?'badge bg-dark':''">Estado:
                                        </span>
                                        <span style="border-radius:5px" class="badge text-success">{{
                                            gestionarEstado(solicitud.estado) }} </span>
                                    </h5>
        ...
        <div class="modal fade" id="modalRespaldos" tabindex="-1" aria-labelledby="miModalLabel" aria-hidden="true"
            data-bs-backdrop="static">
            <div class="modal-dialog modal-xl" style="width:90%; max-width:90%">
                <div class="modal-content border border-2 border-primary">
                    ...
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title text-white" id="miModalLabel">
                            <i class="fas fa-folder-open me-2"></i>Gestión de respaldos
                        </h5>
                        <button type="button" class="btn-close btn-close-white" @click="cerrarModalRespaldos()"
                            data-bs-dismiss="modal" aria-label="Cerrar"></button>
                    </div>
                    ...
                    <div class="modal-body p-4">
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            <div v-for="(item, index) in items_respaldos" :key="index" class="col">
                                <div class="card h-100 shadow-sm border-0">
                                    <div class="card-header bg-light p-2">
                                        <input v-model="item.descripcion" type="text"
                                            class="form-control form-control-sm" placeholder="Ingrese una descripción">
                                        <div class="invalid-feedback">Por favor, ingrese una descripción</div>
                                    </div>
                                    <div class="card-body p-2">
                                        <div class="position-relative overflow-hidden" style="height: 200px;">
                                            <img :src="getImageSrc(item.imagen)"
                                                class="img-fluid w-100 h-100 object-fit-cover rounded" alt="Respaldo"
                                    ...
                                    <div class="card-footer bg-light p-2">
                                        <div class="input-group input-group-sm">
                                            <input type="file" class="form-control" accept="image/*"
                                                @change="seleccionarRespaldo($event, index)"
                                                :id="'file-input-' + index">
                                            <button class="btn btn-success" @click="agregarRespaldo()"
                                                title="Agregar respaldo">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                            <button class="btn btn-danger" @click="quitarRespaldo(index)"
                                                :disabled="items_respaldos.length === 1" title="Eliminar respaldo">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-secondary" @click="cerrarModalRespaldos()"
                            data-bs-dismiss="modal">
                            <i class="fas fa-times me-2"></i>Cerrar
                        </button>
                        <button type="button" class="btn btn-primary" @click="guardarRespaldos()"
            ...
            <div class="modal-dialog modal-xl" style="max-width:90%; width:90%">
                <div class="modal-content border border-success border-2">
                    <div class="modal-header bg-success">
                        ...
                        <button @click="cerrarModalCalculadoraCredito()" type="button" class="btn-close"
                            data-bs-dismiss="modal" aria-label="Cerrar"></button>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input v-model="solicitud_simulacion.importe_solicitud" class="form-control"
                                        type="number">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select @change="(tipo_tasa=='fija')? seleccionarLapsoCapital():''"
                                        v-model="solicitud_simulacion.lapso_capital" class="form-control" id=""
                                        name="lapso_capital" required>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input v-model="solicitud_simulacion.tasa" type="text" class="form-control"
                                        id="tasa" name="tasa" required
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select @change="(tipo_tasa=='fija')?seleccionarLapsoCapital():''"
                                        v-model="tipo_tasa" class="form-control" id="solicitud_simulacion_tipo_tasa"
                                        name="solicitud_simulacion_tipo_tasa" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input @input="(tipo_tasa=='fija')?seleccionarLapsoCapital():''"
                                        v-model="solicitud_simulacion.fecha_desembolso" type="date"
                                        class="form-control border border-success border-1" id="fecha_desembolso"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input :disabled="(tipo_tasa=='fija')? true:false"
                                        v-model="solicitud_simulacion.fecha_primera_cuota" type="date"
                                        class="form-control border border-success border-1" id="fecha_primera_cuota"
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12 text-center">
                                <button v-if="tipo_tasa=='fija'" @click="generarPlanPagosTasaFijaSimulacion()"
                                    class="btn btn-info mx-2">
                                    <i class="fas fa-lock"></i>
                                    Tasa fija
                                </button>

                                <button v-if="tipo_tasa=='amortizable'" @click="generarPlanPagosSimulacion()"
        ...
        methods: {
            getImageSrc(imagen) {
                return (!imagen || imagen === '')
                    ? this.defaultImage
                    : `img/respaldos/${imagen}`;
            },
            handleImageError(event, index) {
                event.target.src = this.defaultImage;
                this.items_respaldos[index].imagen = null;
            },

            filteredItemsCodeudorMetodo(keyword, index){

                const searchTermLowerCodeudor = keyword.toLowerCase();

                if (keyword === '') {
                    this.lista_codeudores[index].select_codeudor.codeudor.filteredItemsCodeudorAux = [];
                    return;
                }
                this.lista_codeudores[index].select_codeudor.codeudor.filteredItemsCodeudorAux =  this.lista_codeudores[index].select_codeudor.codeudor.items_codeudor.filter(item => {
                    const nombreCodeudorLower = item.nombre.toLowerCase();
                    const ciCodeudorLower = item.ci.toLowerCase();
                    return nombreCodeudorLower.includes(searchTermLowerCodeudor) || ciCodeudorLower.includes(
                        searchTermLowerCodeudor);
                });
            ...
            filteredItemsClienteMetodo(keyword){
                ...
                this.filteredItemsCliente = this.items_cliente.filter(item => {
            ...
            filteredItemsCodeudor(index) {
                const searchTermLowerCodeudor = this.lista_codeudores[index].select_codeudor.codeudor.idd_codeudor
                    .toLowerCase();
            ...
            generarPlanPagosSimulacion() {
                if (this.solicitud_simulacion.importe_solicitud == 0 || this.solicitud_simulacion.nro_cuotas == 0 ||
                    ...
                    let capital_aux = this.solicitud_simulacion.importe_solicitud / this.solicitud_simulacion
                    .nro_cuotas;
                    ...
                    while (contador <= this.solicitud_simulacion.nro_cuotas) {
                        ...
                        let interes = 0;
                        if (contador == 1) {
                            interes = (saldo_capital_aux * (this.solicitud_simulacion.tasa / 100)) / fecha_inicio
                                .daysInMonth();
                        } else {
                            if (this.solicitud_simulacion.lapso_capital == 'Mensual') {
                                interes = (saldo_capital_aux * (this.solicitud_simulacion.tasa / 100)) /
                                dias_inicio_fin;
                            } else {
                                interes = (saldo_capital_aux * (this.solicitud_simulacion.tasa / 100)) / fecha_inicio
                                    .daysInMonth();
                        ...
                        this.lista_cuotas_simulacion.push({
                            ...
                            ahorro: parseFloat(this.solicitud_simulacion.cantidad_ahorro == null || this
                                .solicitud_simulacion.cantidad_ahorro == '' ? 0 : this.solicitud_simulacion
                                .cantidad_ahorro).toFixed(0),
                            seguro: parseFloat(this.solicitud_simulacion.cantidad_seguro == null || this
                                .solicitud_simulacion.cantidad_seguro == '' ? 0 : this.solicitud_simulacion
                                .cantidad_seguro).toFixed(0),
                            ...
                            total_cuota: (() => {
                                ...
                                const ahorro = this.solicitud_simulacion.ahorro ? parseFloat(this
                                    .solicitud_simulacion.cantidad_ahorro || 0) : 0;
                                const seguro = this.solicitud_simulacion.seguro ? parseFloat(this
                                    .solicitud_simulacion.cantidad_seguro || 0) : 0;
                ...
                if (this.solicitud_simulacion.importe_solicitud == 0 || this.solicitud_simulacion.nro_cuotas == 0 ||
                    ...
                    while (contador <= this.solicitud_simulacion.nro_cuotas) {
                        ...
                        if (contador == 1) {
                            ...
                            let numerador_formula = parseFloat(tasa_fija * ((1 + tasa_fija) ** this.solicitud_simulacion
                                .nro_cuotas));
                            let denominador_formula = parseFloat(((1 + tasa_fija) ** this.solicitud_simulacion
                                .nro_cuotas) - 1);
                            ...
                            interes = (this.solicitud_simulacion.lapso_capital == 'Mensual') ? (parseFloat(
                                saldo_capital_aux * (this.solicitud_simulacion.tasa / 100)) / dias_inicio_fin) : (
                                parseFloat(saldo_capital_aux * (this.solicitud_simulacion.tasa / 100)) / 30);
                            ...
                            if (this.solicitud_simulacion.lapso_capital == 'Mensual') {
                                ...
                                let numerador_formula = parseFloat(tasa_fija * ((1 + tasa_fija) ** this
                                    .solicitud_simulacion.nro_cuotas));
                                let denominador_formula = parseFloat(((1 + tasa_fija) ** this.solicitud_simulacion
                                    .nro_cuotas) - 1);
                                ...
                                interes = parseFloat(saldo_capital_aux * (this.solicitud_simulacion.tasa / 100)) /
                                    dias_inicio_fin;

                                console.log('Cuota tasa fija', cuotaTasaFija);
                            } else {
                                // interes=(saldo_capital_aux*(this.solicitud_simulacion.tasa/100))/fecha_inicio.daysInMonth();
                                let tasa_pago = parseFloat(((this.solicitud_simulacion.tasa / 100) / 30) *
                                    dias_inicio_fin);
                                let tasa_fija = tasa_pago;
                                ...
                                cuotaTasaFija = parseFloat(monto_total * (numerador_formula / denominador_formula));
                                interes = parseFloat(parseFloat(saldo_capital_aux * (this.solicitud_simulacion.tasa /
                                    100))) / 30;
                        ...
                        this.lista_cuotas_simulacion.push({
                            ...
                            saldo_capital: Math.round(parseFloat(parseFloat(saldo_capital_aux -
                                abono_capital_cuota))),
                            ahorro: parseFloat(this.solicitud_simulacion.cantidad_ahorro == null || this
                                .solicitud_simulacion.cantidad_ahorro == '' ? 0 : this.solicitud_simulacion
                                .cantidad_ahorro).toFixed(0),
                            ...
                            total_cuota: (() => {
                                ...
                                const ahorroMonto = this.solicitud_simulacion.ahorro ? parseFloat(this
                                    .solicitud_simulacion.cantidad_ahorro || 0) : 0;
                                const seguroMonto = this.solicitud_simulacion.seguro ? parseFloat(this
                                    .solicitud_simulacion.cantidad_seguro || 0) : 0;
            ...
            async guardarRespaldo(index) {
                if (this.respaldo.imagen != undefined && this.respaldo.imagen != null) {
                    ...
                    await axios.post('/imagenRespaldo', formData)
                        .then((response) => {
            ...
            async seleccionarRespaldo(event, index) {
                ...
                if (this.items_respaldos[index].descripcion != '') {
                    ...
                    await this.guardarRespaldo(index);
            ...
            cambiarEstadoSimulacion() {
                this.solicitud_simulacion.cantidad_ahorro = this.solicitud_simulacion.ahorro ? this.solicitud_simulacion
                    .cantidad_ahorro : 0;
                this.solicitud_simulacion.cantidad_seguro = this.solicitud_simulacion.seguro ? this.solicitud_simulacion
                    .cantidad_seguro : 0;
                if (this.lista_cuotas_simulacion.length > 0) {
            ...
            generarPlanPagosTasaFija() {
                ...
                while (contador <= this.solicitud.nro_cuotas) {
                    ...
                    if (contador == 1) {
                        ...
                        interes = (this.solicitud.lapso_capital == 'Mensual') ? (parseFloat(saldo_capital_aux * (this
                            .solicitud.tasa / 100)) / dias_inicio_fin) : (parseFloat(saldo_capital_aux * (this
                            .solicitud.tasa / 100)) / 30);
                        ...
                        if (this.solicitud.lapso_capital == 'Mensual') {
                            ...
                            let numerador_formula = parseFloat(tasa_fija * ((1 + tasa_fija) ** this.solicitud
                                .nro_cuotas));
                            let denominador_formula = parseFloat(((1 + tasa_fija) ** this.solicitud.nro_cuotas) - 1);
                    ...
                    this.lista_cuotas.push({
                        ...
                        saldo_capital: Math.round(parseFloat(parseFloat(saldo_capital_aux -
                            abono_capital_cuota))),
                        ahorro: parseFloat(this.cantidad_ahorro == null || this.cantidad_ahorro == '' ? 0 : this
                            .cantidad_ahorro).toFixed(0),
                        seguro: parseFloat(this.cantidad_seguro == null || this.cantidad_seguro == '' ? 0 : this
                            .cantidad_seguro).toFixed(0),
            ...
            generarPlanPagos() {
                ...
                while (contador <= this.solicitud.nro_cuotas) {
                    ...
                    this.lista_cuotas.push({
                        ...
                        seguro: parseFloat(this.cantidad_seguro == null || this.cantidad_seguro == '' ? 0 : this
                            .cantidad_seguro).toFixed(0),
                        total_cuota: parseFloat(parseFloat(capital_aux) + parseFloat(interes *
                            dias_inicio_fin) + (this.ahorro ? parseFloat(this.cantidad_ahorro) : 0) + (this
            ...
            abrirModalSimulacionPlanPago(item) {
                ...
                this.cliente_simulacion = this.items_cliente_simulacion.find(objeto => objeto.id == item.id_cliente) ||
                    null;
            ...
            seleccionarImagen(event, index, index_padre, item) {
                ...
                if (input.files && input.files[0]) {
                    ...
                    let guardado = false;
                    const formData = new FormData();
                    formData.append('imagen', this.lista_garantias_imagenes[index_padre].lista_imagenes[index]
                        .imagen_file);
                    formData.append('id_garantia', this.lista_garantias_imagenes[index_padre].lista_imagenes[index]
                        .id_garantia);
                    formData.append('id_imagen', this.lista_garantias_imagenes[index_padre].lista_imagenes[index]
                        .id_imagen);
            ...
            eliminarImagen(index_padre, index_hijo) {
                ...
                if (this.lista_garantias_imagenes[index_padre].lista_imagenes[index_hijo].id_garantia == 0) {
                    ...
                    axios.get('/eliminar_imagen?id_imagen=' + this.lista_garantias_imagenes[index_padre].lista_imagenes[
                            index_hijo].id_imagen)
                        .then((response) => {
                            console.log(response);
            ...
            seleccionarCodeudor(item, index) {
                ...
                this.lista_codeudores[index].select_codeudor.codeudor.idd_codeudor = item.nombre;
            ...
            async guardarSolicitud() {
                try {
                    ...
                    if (!algunValorEsVacio || (tieneCamposVaciosGarantias && this.solicitud.tipo_garantia ===
                            'Prendario')) {
                        Swal.fire({
                            position: 'center',
                            icon: 'warning',
            ...
            modificarSolicitud() {
                ...
                if(algunValorEsVacio==true){
                    ...
                    console.log('valor vacio', algunValorEsVacio);
                    //console.log('tiene campos vacios', tieneCamposVaciosGarantias );
                    return; // Detener el proceso si hay campos vacíos
                }
                if (tieneCamposVaciosGarantias && this.solicitud.tipo_garantia ==='Prendario') {
                    Swal.fire({
                        position: 'center',
                        icon: 'warning',
                        title: 'Advertencia',
                        text: 'Debe completar los campos requeridos para solicitud prendaria',
                        showConfirmButton: true,
                    });
                    console.log('tiene campos vacios', tieneCamposVaciosGarantias);
                    //console.log('tiene campos vacios', tieneCamposVaciosGarantias );
            ...
            async getSolicitudes(page) {
                await axios.get('/get_solicitudes?page=' + page + '&criterio=' + this.criterio + '&buscar=' + this
                        .buscar + '&estado=' + this.criterio_estado +
                    ...
                    this.lista_codeudores.push({
                        select_codeudor: {
                            ...
                            codeudor: {
                                ...
                                idd_codeudor: this.items_codeudores_solicitud[i].nombre,
                                nombre: '',
                                actividad: this.items_codeudores_solicitud[i].actividad,
                                ci: this.items_codeudores_solicitud[i].ci + ' - ' + this
                                    .items_codeudores_solicitud[i].lugar_expedicion,
                                lugar_expedicion: this.items_codeudores_solicitud[i].lugar_expedicion,
                                buscar: this.items_codeudores_solicitud[i].nombre + ' ' + this
                                    .items_codeudores_solicitud[i].ci,
